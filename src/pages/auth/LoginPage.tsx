      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div>
          ...
          <div className="flex items-center justify-between mt-2">
            <label className="flex items-center gap-2 text-sm text-textSecondary cursor-pointer">
              <input type="checkbox" className="rounded border-borderLight text-primary focus:ring-primary" />
              Remember me
            </label>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="bg-background px-2 text-textSecondary">Or continue with</span>
          </div>
        </div>

        <Button type="button" variant="secondary" className="w-full gap-2" onClick={onGoogleLogin}>
